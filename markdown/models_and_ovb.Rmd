...
In the system we have setup, there is no uncorrelated site-level variability. It's all at the site-year (or site-plot) level. We could indeed run these models with *no site random effect*. They would produce the same answers. (You will notice they are commented out in the above code. Add them back in and see for your own edification).
